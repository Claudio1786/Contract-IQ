    ...
    <AppLayout>
      <div>
        ...
        <div style={{ marginBottom: 'var(--space-6)' }}>
          <h1 className="text-h1">Upload Customer Contract</h1>
          <p className="text-base text-secondary" style={{ marginTop: 'var(--space-2)' }}>
            Upload a customer contract to analyze redlines, identify negotiation points, and generate counter-proposals.
          </p>
        </div>
