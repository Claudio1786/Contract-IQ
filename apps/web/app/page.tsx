    ...
    <>
      ...
      <section className="hero">
        <div className="hero-content">
          <div className="hero-badge">AI-Powered Revenue Intelligence for Revenue Teams</div>
        ...
        <div className="features-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Contract IQ is built for teams managing 200+ customer contracts. RevOps, CS, Sales — if you own revenue growth and retention, this is for you.
            </p>
          </div>
      ...
      <section className="cta-section" id="demo">
        <div className="cta-content">
          ...
          <p className="cta-subtitle">
            Join teams using Contract IQ to eliminate revenue leakage and maximize customer lifetime value. Full platform access, no credit card required.
          </p>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <p className="footer-text">
            © 2024 Contract IQ. Revenue intelligence for customer contracts.
          </p>
        </div>
      </footer>
    </>
