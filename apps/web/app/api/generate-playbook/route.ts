...
export async function POST(request: NextRequest) {
  try {
    console.log('📥 Playbook generation request received');
    ...
    if (!process.env.GEMINI_API_KEY) {
      console.error('❌ GEMINI_API_KEY environment variable not set - using fallback');
    ...
    console.log('📋 Request data:', { contractType, scenario, objectives });
    ...
    try {
      ...
      console.error('❌ Error building enhanced prompt:', promptError);
      return NextResponse.json(
    ...
    console.log('🤖 Generating playbook with Gemini...');
